...
class AddTeamPage(Base):
    def __init__(self):
        self.volunteer_service = By.XPATH, "//span[contains(text(),'志愿服务')]"
        self.volunteer_team = By.XPATH, "//a[@href='/volunteer_team']"
        self.add_team_iframe = By.XPATH, "//iframe[@src='/volunteer_team']"
        self.create_team = By.XPATH, "//button/span[contains(text(),  '创建团队')]"
        self.team_name = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[1]/div/div[1]/input'
        self.team_name_all = By.XPATH, "//*[@id='app']/div[3]/div/div[2]/form/div[2]/div/div[1]/input"
        self.team_image = By.XPATH, "//input[@name='file']"
        self.team_builder = By.XPATH, "//*[@id='app']/div[3]/div/div[2]/form/div[4]/div/div/input"
        self.team_yunying_select = By.XPATH, "// button / span[contains(text(), '选择')]"
        self.team_yunying_input = By.XPATH, '//input[ @ placeholder = "请输入志愿者姓名/手机号"]'
        self.team_yunying_select_btn = By.XPATH, '/html/body/div[2]/div/div[2]/form/div[2]/div/button/span'
        self.team_yunying_select_confirm = By.XPATH, '/html/body/div[2]/div/div[2]/div[1]/div[4]/div[2]/table/tbody/tr/td[5]/div/button/span'
        self.team_date = By.XPATH, '//input[@placeholder="选择日期"]'
        self.team_date_comfirm = By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/table[1]/tbody/tr[2]/td[2]/div/span'
        self.team_province = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[7]/div/div[1]/div/div/div/div/input'
        self.team_province_comfirn = By.XPATH, '/html/body/div[5]/div[1]/div[1]/ul/li[1]/span'
        self.team_shi = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[7]/div/div[2]/div/div/div/div/input'
        self.team_shi_comfirn = By.XPATH, '/html/body/div[6]/div[1]/div[1]/ul/li'
        self.team_qu = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[7]/div/div[3]/div/div/div/div/input'
        self.team_qu_comfirn = By.XPATH, '/html/body/div[7]/div[1]/div[1]/ul/li[1]/span'
        self.team_office = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[8]/div/div[1]/input'
        self.team_connecter = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[9]/div/div[1]/input'
        self.team_phone = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[10]/div/div[1]/input'
        self.team_service = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[11]/div/div[1]/label[1]/span[2]'
        self.team_introduce = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[12]/div/div[1]/textarea'
        self.team_create_now = By.XPATH, '//*[@id="app"]/div[3]/div/div[2]/form/div[13]/div/button[1]/span'
...
class AddTeamAction:
    def __init__(self):
        self.add_team_page = AddTeamPage()

    def click_get_volunteer_service(self):
        self.add_team_page.get_volunteer_service().click()

    def click_volunteer_team(self):
        self.add_team_page.get_volunteer_team().click()

    def switch_add_team_iframe(self):
        DriverUntil.get_driver().switch_to.frame(self.add_team_page.get_add_team_iframe())

    def click_create_team(self):
        self.add_team_page.get_create_team().click()

    def input_team_name(self, team_name):
        self.add_team_page.get_team_name().send_keys(team_name)

    def input_team_name_all(self, team_name_all):
        self.add_team_page.get_team_name_all().send_keys(team_name_all)

    def input_team_image(self, image_url):
        self.add_team_page.get_team_image().send_keys(image_url)

    def input_team_builder(self, team_builder):
        self.add_team_page.get_team_builder().send_keys(team_builder)

    def click_team_yunying_select(self):
        self.add_team_page.get_team_yunying_select().click()

    def input_team_yunying_input(self, team_yunying):
        self.add_team_page.get_team_yunying_input().send_keys(team_yunying)

    def click_team_yunying_select_btn(self):
        self.add_team_page.get_team_yunying_select_btn().click()

    def click_team_yunying_select_confirm(self):
        self.add_team_page.get_team_yunying_select_confirm().click()

    def click_team_date(self):
        self.add_team_page.get_team_date().click()

    def click_team_date_comfirm(self):
        self.add_team_page.get_team_date_comfirm().click()

    def click_team_province(self):
        self.add_team_page.get_team_province().click()

    def click_team_province_comfirn(self):
        self.add_team_page.get_team_province_comfirn().click()

    def click_team_shi(self):
        self.add_team_page.get_team_shi().click()

    def click_team_shi_comfirn(self):
        self.add_team_page.get_team_shi_comfirn().click()

    def click_team_qu(self):
        self.add_team_page.get_team_qu().click()

    def click_team_qu_comfirn(self):
        self.add_team_page.get_team_qu_comfirn().click()

    def input_team_office(self, team_office):
        self.add_team_page.get_team_office().send_keys(team_office)

    def input_team_connecter(self, team_connecter):
        self.add_team_page.get_team_connecter().send_keys(team_connecter)

    def input_team_phone(self, team_phone):
        self.add_team_page.get_team_phone().send_keys(team_phone)

    def click_team_service(self):
        self.add_team_page.get_team_service().click()

    def input_team_introduce(self, team_introduce):
        self.add_team_page.get_team_introduce().send_keys(team_introduce)

    def click_team_create_now(self):
        self.add_team_page.get_team_create_now().click()
...
class AddTeamBusiness:
    ...
    def __init__(self):
       self.add_team_action = AddTeamAction()
